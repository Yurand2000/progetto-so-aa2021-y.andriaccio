...
#define MESSAGE_RFILE_ACK SRV_MSG(5)
#define MESSAGE_LFILE_ACK SRV_MSG(6)
#define MESSAGE_ULFILE_ACK SRV_MSG(7)
#define MESSAGE_READ_DATA SRV_MSG(8)
#define MESSAGE_WRITE_ACK SRV_MSG(9)
#define MESSAGE_APPEND_ACK SRV_MSG(10)
...
#define MESSAGE_WRITE_FILE CNT_MSG(6)
#define MESSAGE_APPEND_FILE CNT_MSG(7)
#define MESSAGE_LOCK_FILE CNT_MSG(8)
